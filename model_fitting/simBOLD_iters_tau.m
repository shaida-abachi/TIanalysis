function [bold, savePerf, correctAns, saveW] = simBOLD_iters_tau(stim, inh, iters, varargin)

% simBOLD_iters_tau runs through simBOLD for many iterations 
...
%         display(i_stim)
        ...
        [perf, traces] = TI_sim_trial_tau(param); 
