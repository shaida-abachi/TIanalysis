function [bold, savePerf, correctAns, saveW] = simBOLD_itersMI(stim, inh, iters, varargin)

% simBOLD_itersMI runs through simBOLD for many iterations WITH A TAU OF
% ZERO
...
param.tau   = 0; %20; SPLA edited 072023
...
%         display(i_stim)
        ...
        [perf, traces] = TI_sim_trialMI(param); 
